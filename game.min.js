var __extends=this&&this.__extends||function(t,e){function i(){this.constructor=t}for(var s in e)e.hasOwnProperty(s)&&(t[s]=e[s]);t.prototype=null===e?Object.create(e):(i.prototype=e.prototype,new i)};System.register("state/Boot",[],function(t){"use strict";var e;return{setters:[],execute:function(){e=function(t){function e(){t.apply(this,arguments)}return __extends(e,t),e.prototype.preload=function(){this.load.image("preload-bar","assets/loading.png")},e.prototype.create=function(){this.game.stage.backgroundColor=16777215,this.input.maxPointers=2,this.stage.disableVisibilityChange=!0,this.game.state.start("preload")},e}(Phaser.State),t("default",e)}}}),System.register("touch/Joystick",[],function(t){"use strict";var e,i,s,n,a,o,r,c;return{setters:[],execute:function(){e=Phaser.Sprite,i=Phaser.Point,s=Math,n=function(t){function e(e,i){t.call(this,e,i)}return __extends(e,t),e.prototype.addJoystick=function(t,e){var i=new r(this.game,40,280);return this.game.add.existing(i),i},e.prototype.addButton=function(t,e,i){var s=new a(this.game,t,e,i);return this.game.add.existing(s),s},e}(Phaser.Plugin),t("VirtualJoystick",n),a=function(t){function e(e,i,s,n){var a=e.add.bitmapData(64,64);a.ctx.beginPath(),a.ctx.arc(32,32,32,0,Phaser.Math.PI2),a.ctx.fillStyle="#0088ff",a.ctx.fill(),t.call(this,e,i,s,a),this.inputEnabled=!0,this.innerText=new Phaser.Text(e,0,0,n,""),this.fixedToCamera=!0,this.addChild(this.innerText)}return __extends(e,t),e}(e),t("VButton",a),o=function(){function t(t){this.ctx=t.ctx}return t.prototype.circle=function(t,e,i,s,n,a){return void 0===n&&(n=0),this.ctx.save(),this.ctx.beginPath(),this.ctx.translate(t,e),this.ctx.arc(0,0,i,0,Phaser.Math.PI2),this.ctx.lineWidth=n,this.ctx.strokeStyle=s,a&&(this.ctx.fillStyle=a,this.ctx.fill()),this.ctx.stroke(),this.ctx.restore(),this},t.prototype.triangle=function(t,e,i,s){return this.ctx.save(),this.ctx.translate(t,e),this.ctx.rotate(i),this.ctx.beginPath(),this.ctx.moveTo(0,-10),this.ctx.lineTo(10,10),this.ctx.lineTo(-10,10),this.ctx.lineTo(0,-10),this.ctx.fillStyle=s,this.ctx.closePath(),this.ctx.fill(),this.ctx.restore(),this},t}(),r=function(t){function e(e,n,a){var r=e.add.bitmapData(128,128);new o(r).circle(64,64,60,"#777",8).circle(64,64,50,"#AAA",16).triangle(116,64,s.PI/2).triangle(64,116,s.PI).triangle(12,64,-s.PI/2).triangle(64,12,0),t.call(this,e,n,a,r),this.inputEnabled=!0,this.events.onInputDown.add(this.onDown,this),this.events.onInputUp.add(this.onUp,this),this.pad=new c(e,32,32),this.addChild(this.pad),this.alpha=.5,this.fixedToCamera=!0,this.speed=new i}return __extends(e,t),e.prototype.onDown=function(t,e){this.initialPos=e.position.clone(),this.pointer=e},e.prototype.onUp=function(t,e){this.initialPos=null,this.pointer=null,this.pad.cameraOffset.x=32,this.pad.cameraOffset.y=32,this.speed=new i},e.prototype.preUpdate=function(){if(t.prototype.preUpdate.call(this),this.initialPos){var e=this.initialPos.distance(this.pointer.position),i=50,n=this.pointer.position,a=n.x-this.initialPos.x,o=n.y-this.initialPos.y,r=this.initialPos.angle(this.pointer.position);e>i&&(a=s.cos(r)*i,o=s.sin(r)*i),this.speed.x=a/i*100,this.speed.y=o/i*100,this.pad.cameraOffset.x=a+32,this.pad.cameraOffset.y=o+32}},e}(e),t("Joystick",r),c=function(t){function e(e,i,s){var n=e.add.bitmapData(64,64),a=n.ctx.createLinearGradient(0,0,0,15);a.addColorStop(0,"black"),a.addColorStop(1,"rgba(100, 100, 100, 1)"),new o(n).circle(32,32,25,"black",4,a),t.call(this,e,i,s,n),this.fixedToCamera=!0}return __extends(e,t),e}(e)}}}),System.register("state/Main",["touch/Joystick"],function(t){"use strict";var e,i;return{setters:[function(t){e=t}],execute:function(){i=function(t){function i(){t.apply(this,arguments),this.nbClick=0}return __extends(i,t),i.prototype.create=function(){var t="go !";this.text=this.add.text(10,200,"Let's "+t,{font:"65px Arial"}),this.stage.backgroundColor="#CCCCCC",this.touchControl=this.game.plugins.add(e.VirtualJoystick),this.joystick=this.touchControl.addJoystick(40,280);var i=this.touchControl.addButton(500,280,"jump");i.events.onInputDown.add(this.onJump,this)},i.prototype.onJump=function(){this.game.add.tween(this.text).to({y:this.text.y-20},100,Phaser.Easing.Elastic.Out).start()},i.prototype.update=function(){this.text.position.x+=this.joystick.speed.x/4,this.text.position.y+=this.joystick.speed.y/4,this.game.world.wrap(this.text,0,!0)},i.prototype.render=function(){t.prototype.render.call(this)},i}(Phaser.State),t("default",i)}}}),System.register("state/Preload",[],function(t){"use strict";var e;return{setters:[],execute:function(){e=function(t){function e(){t.apply(this,arguments)}return __extends(e,t),e.prototype.preload=function(){this.preloadBar=this.add.sprite(290,290,"preload-bar"),this.load.setPreloadSprite(this.preloadBar)},e.prototype.create=function(){this.game.state.start("main")},e}(Phaser.State),t("default",e)}}}),System.register("Game",["state/Boot","state/Main","state/Preload"],function(t){"use strict";var e,i,s,n;return{setters:[function(t){e=t},function(t){i=t},function(t){s=t}],execute:function(){n=function(t){function n(){t.call(this,{width:768,height:432,enableDebug:!0,state:new e["default"],renderer:Phaser.AUTO}),this.state.add("preload",s["default"]),this.state.add("main",i["default"])}return __extends(n,t),n.prototype.boot=function(){t.prototype.boot.call(this),this.device.desktop===!1&&(this.scale.scaleMode=Phaser.ScaleManager.SHOW_ALL,this.scale.forceOrientation(!0,!1)),this.scale.pageAlignHorizontally=!0,this.scale.pageAlignVertically=!0},n}(Phaser.Game),t("default",n)}}});
